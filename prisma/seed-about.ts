...
async function main() {
  await prisma.page.upsert({
    ...
    create: {
      ...
      body: {
        he: "ליידי דיאמונד נוסדה ב-2010 מתוך אהבה לתכשיטים פשוטים שמלווים אותך כל יום. כל פריט מעוצב בבית ומיוצר בקפידה מזהב וכסף 925, מתוך אמונה שתכשיט טוב לא צריך לצעוק כדי להיראות — הוא פשוט נראה נכון.\n\nאנחנו חנות משפחתית קטנה שגדלה בזכות לקוחות שחוזרים, וכל הזמנה מטופלת באופן אישי מהקצה אל הקצה.",
